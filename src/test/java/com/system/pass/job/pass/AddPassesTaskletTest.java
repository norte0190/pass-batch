package com.system.pass.job.pass;
...
import com.system.pass.repository.pass.BulkPassEntity;
import com.system.pass.repository.pass.BulkPassRepository;
import com.system.pass.repository.pass.BulkPassStatus;
import com.system.pass.repository.pass.PassEntity;
import com.system.pass.repository.pass.PassRepository;
import com.system.pass.repository.pass.PassStatus;
import com.system.pass.repository.user.UserGroupMappingEntity;
import com.system.pass.repository.user.UserGroupMappingRepository;
...
public class AddPassesTaskletTest {
    ...
    public void test_execute() {
        ...
        when(bulkPassRepository.findByStatusAndStartedAtGreaterThan(eq(BulkPassStatus.READY),
            any())).thenReturn(List.of(bulkPassEntity));
